package com.brainacademy.gui.app.ui.controls;
...
public class AutocompleteJComboBox<T extends Comparable<T>>
        extends JComboBox {
            ...
            tc.getDocument().addDocumentListener(new DocumentListener() {
                ...
                public void update() {
                    ...
                    SwingUtilities.invokeLater(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            List<T> founds = new ArrayList<>(searchable.search(tc.getText()));
                            Set<String> foundSet = new HashSet<String>();
                            for (T item : founds) {
                                foundSet.add(item.toString().toLowerCase());
                            }
